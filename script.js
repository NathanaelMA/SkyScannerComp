function getInputValue(){
	...
	const settings = {
		"async": true,
		"crossDomain": true,
		"url": "https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browseroutes/v1.0/US/"+currency+"/US/"+originPlace+"/"+destinationPlace+"/"+outboundDate+"?inboundpartialdate="+inboundDate,
		"method": "GET",
		"headers": {
	...
	$.ajax(settings).done(function (response) {
		...
		var noresponse = "No flights available. Please try new inputs!"
		...
		for (var j = 0; j < response.Quotes.length; j++){
			...
			if (originPlace.toUpperCase() === response.Places[0].IataCode){
